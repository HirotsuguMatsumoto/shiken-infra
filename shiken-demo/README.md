...
If you want to develop against something other than the default host, localhost:8080, you can set the `REACT_APP_API_BASE` environment variable:
...
Don't forget to edit the `.env` file and update the `BACKEND_CORS_ORIGINS` value (add `http://mydomain:80` to the allowed origins).
